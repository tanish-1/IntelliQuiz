...
def teacher_view_marks_view(request, pk):
    courses = QMODEL.Course.objects.all()  # ✅ Corrected
...
def teacher_check_marks_view(request, pk):
    course = QMODEL.Course.objects.get(id=pk)  # ✅ Corrected
    student_id = request.COOKIES.get('student_id')
    student = SMODEL.Student.objects.get(id=student_id)

    results = Result.objects.all().filter(exam=course, student=student)  # ✅ Already imported correctly
